...
<div class="container-fluid">
	...
	<div class="row">
		<!--col-->
		<div class="col-md-12">
			<h2 class="page-title">Grafik Jenis Barang</h2>
				<!--form-->
      ...
      <div class="">
        <input type="submit" class="btn btn-primary btn m-l-15 waves-effect" value="Cari" name="cari">
          <!-- <a  href="javascript:printDiv('cetak_perencanaan');" class="btn btn-success waves-effect">Cetak</a> -->
           <a href="javascript:void(0);" class="btn btn-success waves-effect" onclick="window.open('laporan_jumlah_tkrs.php?tahun=<?php echo $inputan_tahun; ?>','nama_window_pop_up')">Cetak Laporan</a> 
       </div>
     </div>
     </form>				
				<!-- end form-->
