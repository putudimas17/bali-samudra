...
<div class="container-fluid">
	...
	<div class="row">
		<!--col-->
		<div class="col-md-12">
			<h2 class="page-title">Laporan Pembelian per Supplier</h2>
    				<form method="post" class="form-horizontal" action="laporan_supplier/cetak_laporan_supplier.php">
...
$modal=mysqli_query($db,"SELECT tb_pembelian.tgl, tb_supel.Nama, tb_barang.nama_brg, tb_detail_pembelian.jumlah,tb_detail_pembelian.harga, tb_detail_pembelian.total
...
?>
	<tr>
      ...
      <td><?php echo  'Rp '.$harga_format; ?></td>
