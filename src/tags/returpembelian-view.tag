<retur-pembelian-view class="container-fluid transaksi">
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="form-group">
							...
							<div class="controls col-sm-9">
								<input id="field1" type="text" class="form-control k-textbox" value="{tb_retur_pembelian.INV_pembelian}" data-role="text" data-parsley-errors-container="#errId1" readonly>
								<span id="errId1" class="error"></span>
							</div>
						</div>						
					</div>
						...
						<div class="row">
							<div class="form-group">
								...
								<div class="controls col-sm-8">
									<input id="txtGrandTotal" ref="text-total" type="text" value="{tb_retur_pembelian.total}" class="form-control k-textbox text-right" readonly>
								</div>
							</div>								
						</div>				
					</div>
	...
	<script>
		...
		let reqDetailReturPembelian = function(callback){
			let formData = new FormData();
			console.log(vm.opts);
			formData.append('id',vm.opts.data.id_retur);
			getRestApiService(formData,returPembelianRequest.viewDetail,function(data){
		...
		this.on('mount',function(){
			reqDetailReturPembelian(function(data){
				console.log(data);
