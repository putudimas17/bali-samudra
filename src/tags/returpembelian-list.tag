<table-retur-pembelian>
	<div class="container-fluid">
		<!-- row -->
		<div class="row">
			<!--col-->
			<div class="col-md-12">
				<h2 class="page-title">Data Retur Pembelian</h2>
				<div class="panel-heading">
					<p><a href="#" class="btn btn-success" onclick="{handleTambahBeli.bind(this)}">Tambah Transaksi Retur Pembelian</a>
					</p>
				</div>
				<div class="form">
					<div></div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table id="zctb" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<tr each="{item,index in tb_retur_pembelian}">
	...
	<script>
		...
		let req_rListPembelian = function(callback){
			var formData = new FormData();
			formData.append('empty','');
			getRestApiService(formData,returPembelianRequest.fetchReturPembelian,function(data){
