<table-retur-penjualan>
	<div class="container-fluid">
		<!-- row -->
		<div class="row">
			<!--col-->
			<div class="col-md-12">
				<h2 class="page-title">Data Retur Penjualan</h2>
				<div class="panel-heading">
					<p><a href="#" class="btn btn-success" onclick="{handleTambahBeli.bind(this)}">Tambah Transaksi Retur Penjualan</a>
					</p>
				</div>
				<div class="form">
					<div></div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table id="zctb" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<tr each="{item,index in tb_retur_penjualan}">
									...
									<td align="center">
										<a href="#" data-target="#EditDataPembelian" data-toggle="modal" data-backdrop="static" onclick="{handleViewDetail.bind(this,item.id)}" class="fa fa-edit"-></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<!--
	...
	<script>
		...
		let req_rListPenjualan = function(callback){
			var formData = new FormData();
			formData.append('empty','');
			getRestApiService(formData,returPenjualanRequest.fetchReturPenjualan,function(data){
		...
		this.handleViewDetail = function(id_retur,e){
