...
<!-- menu -->
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="?page=datatiket"><i class="fa fa-file-text-o"></i> Data Tiket Tempat wisata</a></li>
				<li><a href="?page=dataagent"><i class="fa fa-users"></i> Data Agent_tiket</a></li>
	...
	} else if($page == "dataagent")
	{
		include "agent/agent.php";
