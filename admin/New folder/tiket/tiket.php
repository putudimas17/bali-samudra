...
?>
	<tr>
            ...
            <a href="#" class="hapus_modal fa fa-trash-o"  onclick="confirm_modal('tiket/barang_hapus.php?&kode_brg=<?php echo  $r['kode_brg']; ?>');" ></a>
            </td>
	</tr>
		<?php 
	}
			...
			<div class="modal-content">
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
						<div class="panel panel-default">
							<div class="panel-heading" align="center">Tambah Data tiket</div>
							<div class="panel-body">
								<!-- form add data -->
								<form method="POST">
...
$cek=mysqli_num_rows($query);
		if($cek>=1)
		{
			echo "<script> alert('Data sudah pernah diinput, Coba Periksa Lagi!');window.location='index.php?page=datatiket';</script>";
